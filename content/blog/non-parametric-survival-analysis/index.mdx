...
embeddedImagesLocal:
  ...
  - km-treatment.png
  - loglog.png
  - survival-bias-1.jpeg
  - survival-bias-2.jpeg
---
...
<Marginnote id="km-general-legend" tag="p" className="mb-0">
...
<GatsbyImage alt="general kaplan meier curve" image={getImage(props.localImages[0])} />

</figure>

<figure>

<Marginnote id="km-gender-legend" tag="p" className="mb-0">
...
<GatsbyImage alt="kaplan meier curves by gender groups" image={getImage(props.localImages[1])} />

</figure>

<figure>

<Marginnote id="km-treatment-legend" tag="p" className="mb-0">
...
<GatsbyImage alt="kaplan meier curves by treatment groups" image={getImage(props.localImages[2])} />
...
<GatsbyImage alt="survival bias illustration" image={getImage(props.localImages[4])} />

</figure>

<figure>

<Marginnote id="survival-bias-2">
  However, when keeping only the subjects that survived 5 years in all groups for analysis (the landmark method, <a href="http://ascopubs.org/doi/10.1200/JCO.1983.1.11.710" target="_blank" rel="noreferrer">Anderson et al</a>, the advantage is no more.
</Marginnote>

<GatsbyImage alt="corrected survival bias illustration" image={getImage(props.localImages[5])} />
