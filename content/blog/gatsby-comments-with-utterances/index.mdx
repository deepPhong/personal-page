...
<Marginnote id="dark-mode-switch-component">
  When clicked, what the <code>DarkModeSwitch</code> does is
  <ol>
  <li>Switches the theme class of our <code>body</code> element with <code>toggleTheme()</code></li>
  <li>If there is an Utterances iframe in the current page, sends a "message" to it containing the theme we wish to set</li>
</ol>
</Marginnote>
